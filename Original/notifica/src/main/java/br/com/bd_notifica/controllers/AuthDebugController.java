...
public class AuthDebugController {
    ...
    public Map<String, Object> listUsers() {
        try {
            ...
            if (context != null) {
                br.com.bd_notifica.services.UserService userService = context
                        .getBean(br.com.bd_notifica.services.UserService.class);
                ...
                var userList = users.stream().map(user -> Map.of(
                        ...
                        "senhaHash",
                        user.getSenha() != null
                                ? user.getSenha().substring(0, Math.min(20, user.getSenha().length())) + "..."
                                : "NULL"))
                        .toList();
            ...
            if (context != null) {
                ...
                try (java.sql.Connection conn = dataSource.getConnection();
                        ...
                        java.sql.ResultSet rs = stmt
                                .executeQuery("SELECT id, problema, descricao, status, sala_id, user_id FROM ticket")) {
    ...
    public Map<String, Object> debugSalas() {
        try {
            ...
            if (context != null) {
                br.com.bd_notifica.services.SalaService salaService = context
                        .getBean(br.com.bd_notifica.services.SalaService.class);
