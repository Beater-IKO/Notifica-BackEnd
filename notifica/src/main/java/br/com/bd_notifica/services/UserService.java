...
public class UserService {
    ...
    public void criarUserPadrão(){
        UserEntity u1 = new UserEntity(null, "ari", "ari@mail.com", "123", UserRole.ADMIN, LocalDate.now().minusDays(5) );    
        

        UserEntity u2 = new UserEntity(null, "carlos", "carlos@mail.com", "123", UserRole.STUDENT, LocalDate.now().minusDays(4) );
        
       
        UserEntity u3 = new UserEntity(null, "diego", "diego@mail.com", "123", UserRole.AGENT, LocalDate.now().minusDays(3) );
